...
final class Encryption {
	...
	private function get_default_key() {
		if ( defined( 'MAGIC_LOGIN_ENCRYPTION_KEY' ) && '' !== MAGIC_LOGIN_ENCRYPTION_KEY ) {
			return MAGIC_LOGIN_ENCRYPTION_KEY;
		}
	...
	private function get_default_salt() {
		if ( defined( 'MAGIC_LOGIN_ENCRYPTION_SALT' ) && '' !== MAGIC_LOGIN_ENCRYPTION_SALT ) {
			return MAGIC_LOGIN_ENCRYPTION_SALT;
		}
